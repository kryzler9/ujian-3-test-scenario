...
public class TestAdd2Product {
    ...
    @Test
    public void testAdd2Product(){ //Harusnya cuma ditambah 1

        delay(2);
        WebElement addProductBike = driver.findElement(By.xpath("//button[@id='add-to-cart-sauce-labs-bike-light']"));
        addProductBike.click();

        WebElement addAnother = driver.findElement(By.xpath("//button[@id='add-to-cart-sauce-labs-backpack']"));
        addAnother.click();
        ...
        if (cartBadge.isDisplayed()) {
            ...
            Assert.fail("Product yang ditambah kurang dari 2");
        }
        delay(5);
    }
